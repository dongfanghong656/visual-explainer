...
| ID | Requirement | Priority | Status | Detail | Current acceptance state |
|---|---|---:|---|---|---|
| REQ-0001 | Evidence-gated author completion declaration | P0 | ACCEPTED | [REQ-0001](REQ-0001.md) | Public Claim is contract-bound; exact-head R2 and deployed MCP verification pass with limits |
| REQ-0002 | Independent reviewer using the same protocol | P0 | ACCEPTED | [REQ-0002](REQ-0002.md) | Automated exact-head R2 passes with explicit non-human-independence limitation |
| REQ-0003 | Causal change-logic visualization | P0 | ACCEPTED | [REQ-0003](REQ-0003.md) | Contract authority and final-gate overlays are covered by renderer tests |
| REQ-0004 | Deterministic, local, and safe operation | P0 | ACCEPTED | [REQ-0004](REQ-0004.md) | Final Node 20/22, tag, downloaded package, and deployed eight-tool handshake pass |
