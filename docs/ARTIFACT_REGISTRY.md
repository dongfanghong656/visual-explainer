...
| ART-0008 | Locked package and GitHub prerelease workflow | Package 0.11.0-alpha.1 | FULL for GitHub release channel | PACKED_ARTIFACT_USABLE | CLEAN_INSTALL_HANDSHAKE_AND_AUDIT_PASS_LOCAL | RELEASE_CANDIDATE | 97-file packed artifact and eight-tool handshake | Exact-head R2 CI run, tag, publication, and downloaded install pending |
