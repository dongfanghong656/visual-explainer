...
| W8 Release decision | Merge, tag, publish, or remain blocked based on explicit release evidence | TASK-0005 | No unresolved blocker and explicit approval | USER_AUTHORIZED_IN_PROGRESS |
