...
Task Proof uses the separate `visual-explainer-task-proof-mcp` server. Its contract-first claimant/reviewer tools are not registered by this general renderer process.
