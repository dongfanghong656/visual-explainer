...
const manifest = {
  ...
  task: {
    id: 'TPV-V0.1.0-CI',
    title: 'Validate Task Proof Visualizer MVP at the CI checkpoint',
    objective: 'Verify deterministic claim gating, reviewer reconciliation, safe workspace boundaries, diagram generation, and MCP stdio discovery.',
  },
  checkpoint: {
  ...
  evidence: [
    ...
    },
    {
      ...
      summary: 'The implementation and documentation changes under review.',
      result: 'pass',
      trust: 'primary',
    },
    {
